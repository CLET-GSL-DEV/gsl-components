...
| `descriptionAdornment` | `ReactNode` | — | Arbitrary node (icon, JSX, anything) rendered to the left of the description text. Only renders with `description`. |
...
| `descriptionAdornment` | Node left of the description (`.clet-metric-card__description-adornment`) |
