export const meta = {
  title: "Sidebar",
  description:
    "Compound sidebar layout primitives with sticky desktop rail and mobile offcanvas drawer.",
};
...
<ExampleTabs title="App shell" preview={<SidebarPreview />}>
...
<SidebarProvider>
  ...
  <Sidebar>
    ...
    <SidebarFooter>v1.5.0</SidebarFooter>
  </Sidebar>
  <main>{children}</main>
</SidebarProvider>
```
