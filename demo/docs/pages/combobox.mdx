...
import { ComboboxLongPreview } from "../previews/code/ComboboxLongPreview";
import { ComboboxInModalPreview } from "../previews/code/ComboboxInModalPreview";
...
import comboboxLongSource from "../previews/examples/combobox-long.example.tsx?raw";
import comboboxInModalSource from "../previews/examples/combobox-in-modal.example.tsx?raw";
...
<ExampleTabs
  title="Inside a modal (scroll, pick, Escape order)"
  preview={<ComboboxInModalPreview />}
  code={comboboxInModalSource}
/>
