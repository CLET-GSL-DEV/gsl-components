export const meta = {
  title: "DateSelector",
  description: "Date picker built on Radix Popover with calendar grid, month/year navigation, and native date formatting.",
};
...
| Token | Used for |
|-------|----------|
| `--gsl-rounded-base` | Trigger and calendar border radius |
