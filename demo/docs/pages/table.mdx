...
- Selection is page-local: "select all" only selects rows on the current page. Selection is managed internally by `TableContent` — use `onSelectionChange` to track selections for `TableBulkActions`.
