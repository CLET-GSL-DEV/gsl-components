...
| Token | Effect |
|-------|--------|
| `--gsl-surface-subtle` | Header row background |
| `--gsl-bg` | Search, filter trigger, pagination button background (secondary variant) |
| `--gsl-hover` | Skeleton pulse fill, button hover backgrounds |
| `--gsl-primary` | Active page number border, focus ring |
| `--gsl-border` | All borders (rows, inputs, buttons) |
| `--gsl-radius` | All border radii |
| `--gsl-z-popover` | Filter popover z-index |
