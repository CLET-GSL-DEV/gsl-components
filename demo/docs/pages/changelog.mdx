export const meta = {
  ...
  category: "Guide",
  keywords: ["changelog", "release notes", "version history", "whats new"],
  since: "1.0.3",
  status: "guide",
  related: ["migration-v2"],
};
...
Upgrading from any earlier version? See the [migration guide](/docs/migration-v2) for the one upgrade path: run the codemod, then the few things it cannot decide.
