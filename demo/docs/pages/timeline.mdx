...
| `--gsl-timeline-font` | `--gsl-font-body` | Font family for the root `<ol>` |
| `--gsl-timeline-stagger-step` | `60ms` | Per-item animation delay increment (multiplied by item index) |
| `--gsl-timeline-draw-duration` | `300ms` | Duration of the connector line draw-in animation |
| `--gsl-timeline-pop-duration` | `200ms` | Duration of the dot pop-in animation |
| `--gsl-timeline-index` | `0` | Item index used to compute staggered animation delay; set automatically per item |
