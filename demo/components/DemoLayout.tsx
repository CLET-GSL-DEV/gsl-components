...
import { buildSearchResults } from "demo/data/demoSearch";
...
export function DemoLayout() {
  ...
  const { data: notifData, loading: notifLoading } = useMockQuery(demoNotifications, 1500);

  const [searchQuery, setSearchQuery] = useState("");
  const { data: searchData } = useMockQuery(buildSearchResults(searchQuery), 0, searchQuery);
  ...
  const navGroups = [
    {
      label: "Main",
      links: [
        { id: "dashboard", label: "Dashboard", href: "/", icon: LayoutDashboard, badge: "check" },
        { id: "members", label: "Members", href: "/members", icon: Users, badge: "check" },
        { id: "exams", label: "Examinations", href: "#", icon: ClipboardList, badge: "New" },
        { id: "candidates", label: "Candidates", href: "#", icon: GraduationCap, badge: "142" },
        { id: "institutions", label: "Institutions", href: "#", icon: Building2, badge: "12" },
      ],
    },
    {
      label: "Assessment",
      links: [
        { id: "item-bank", label: "Item Bank", href: "#", icon: BookOpen, badge: "843" },
        { id: "moderation", label: "Moderation", href: "#", icon: Shield, badge: "4" },
        { id: "results", label: "Results", href: "#", icon: FileText, badge: "New" },
    ...
    },
    {
      ...
      links: [
        ...
        { id: "billing", label: "Billing", href: "#", icon: CreditCard, badge: "Beta" },
    ...
    },
    {
      ...
      links: [
        ...
        { id: "reports", label: "Reports", href: "#", icon: FileText, badge: "3" },
        { id: "alerts", label: "Alerts", href: "#", icon: Bell, badge: "8" },
        { id: "messages", label: "Messages", href: "#", icon: MessageSquare, badge: "5" },
      ],
    },
    {
      label: "Developer",
    ...
    },
    {
      ...
      links: [
        ...
        { id: "regions", label: "Regions", href: "#", icon: Globe, badge: "Soon" },
      ],
    },
  ];
      ...
      <AppLayout>
        <AppHeader
          ...
          profile={
            ...
            >
              ...
              <button type="button" className="gsl-profile-popover__action gsl-profile-popover__action--danger">
                <span className="gsl-profile-popover__action-icon">
        ...
        <AppSidebar>
          <Sidebar>
            ...
            <SidebarContent ref={contentRef} className={scrolledDown ? "gsl-sidebar__content--scrolled" : undefined}>
              <SidebarNav>
                {navGroups.map((group) => (
                    ...
                    {group.links.map((link) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {link.badge && (
                            <SidebarBadge>
                              {link.badge === "check" ? <Check size={12} strokeWidth={2.5} /> : link.badge}
                            </SidebarBadge>
                          )}
                        </SidebarLink>
                      );
            ...
            <SidebarFooter>
              <button type="button" className="demo-home__sidebar-footer-btn">
                ...
                <span>Settings</span>
                <ChevronRight size={16} strokeWidth={1.5} className="demo-home__sidebar-footer-chevron" />
              </button>
            </SidebarFooter>
          </Sidebar>
        </AppSidebar>
