	...
	const bodyStepClass = useMemo(() => {
		const map: Record<number, string> = {
			[BulkImportStep.UPLOAD]:
				"clet-bulk-import__body--upload gsl-bulk-import__body--upload",
			[BulkImportStep.SELECT_HEADER_ROW]:
				"clet-bulk-import__body--header gsl-bulk-import__body--header",
			[BulkImportStep.MATCH_COLUMNS]:
				"clet-bulk-import__body--match gsl-bulk-import__body--match",
			[BulkImportStep.VALIDATE_DATA]:
				"clet-bulk-import__body--validate gsl-bulk-import__body--validate",
		};
			...
			<ModalPortal>
				...
				>
					<ModalTitle className="clet-bulk-import__header gsl-bulk-import__header">
						<nav
							className="clet-bulk-import__stepper gsl-bulk-import__stepper"
									...
									return (
										<li
											...
											className={[
												...
												isActive
													? "clet-bulk-import__stepper-item--active gsl-bulk-import__stepper-item--active"
													: "",
												isComplete
					...
					<ModalBody
						className={[
							"clet-bulk-import__body gsl-bulk-import__body",
							bodyStepClass,
						]
							.filter(Boolean)
							.join(" ")}
					>
						...
						>
							<h3 className="clet-bulk-import__step-title gsl-bulk-import__step-title">
								Processing
							</h3>
