  ...
  function TabsList({ classNames, className, children, ...props }, ref) {
    ...
    return (
      ...
      >
        ...
        {isLineVariant ? (
          <span
            className={cn("clet-tabs__indicator", classNames?.indicator)}
            aria-hidden
  ...
  function TabsTrigger({ classNames, className, ...props }, ref) {
    return (
      <TabsPrimitive.Trigger
        ref={ref}
        className={cn("clet-tabs__trigger", classNames?.trigger, className)}
        {...props}
      />
    );
  },
  ...
  function TabsContent({ classNames, className, ...props }, ref) {
    return (
      <TabsPrimitive.Content
        ref={ref}
        className={cn("clet-tabs__content", classNames?.content, className)}
        {...props}
      />
    );
  },
