...
>(function AppHeaderNotificationItem(
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "gsl-notif-popover__item",
        !unread && "gsl-notif-popover__item--read",
        classNames?.root,
        className,
      )}
    ...
    >
      {unread ? (
        <div className={cn("gsl-notif-popover__dot", classNames?.dot)} aria-hidden />
      ) : null}
      <div className={cn("gsl-notif-popover__item-body", classNames?.body)}>
        <div className={cn("gsl-notif-popover__body-text", classNames?.text)}>
          {text}
        </div>
        {time ? (
          <div className={cn("gsl-notif-popover__body-time", classNames?.time)}>
            {time}
          </div>
        ) : null}
      </div>
