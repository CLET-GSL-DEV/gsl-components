        ...
        <Popover.Portal>
          ...
          >
            ...
            <div className="clet-notif-popover__body gsl-notif-popover__body">
              {loading ? (
                <div className="clet-notif-popover__loading gsl-notif-popover__loading">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="clet-notif-popover__skeleton gsl-notif-popover__skeleton">
                      ...
                      <div className="clet-notif-popover__skeleton-lines gsl-notif-popover__skeleton-lines">
                        <div className="clet-notif-popover__skeleton-line gsl-notif-popover__skeleton-line" style={{ width: "85%" }} />
                        <div className="clet-notif-popover__skeleton-line gsl-notif-popover__skeleton-line" style={{ width: "50%" }} />
                      </div>
                    </div>
                  ))}
                </div>
